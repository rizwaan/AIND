    ...
    def get_actions(self):
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos:
                        pre_pos = [expr("At({} , {})".format(cargo, airport)),
        ...
        def unload_actions():
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos:
                        pre_pos = [expr("In({}, {})".format(cargo, plane)),
                                       expr("At({}, {})".format(plane, airport)),]
                        pre_neg = []
                ...
                for to in self.airports:
                    if fr != to:
                        for p in self.planes:
                            pre_pos = [expr("At({}, {})".format(p, fr)),]
                            pre_neg = []
                            eff_add = [expr("At({}, {})".format(p, to))]
                            eff_rem = [expr("At({}, {})".format(p, fr))]
